...
func (s *Scope) compileBuildIn(id string, expr *ast.CallExpr) (est.New, reflect.Type, bool, error) {
...
func (s *Scope) compileMake(expr *ast.CallExpr) (est.New, reflect.Type, error) {
	if len(expr.Args) < 2 {
	...
	return est.NewMake(sliceType, args)
}
